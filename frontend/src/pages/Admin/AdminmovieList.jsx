        ...
        <div className="container mx-[9rem]">
            <div className="flex flex-col md:flex-row">
                <div className="p-3">
                    ...
                    <div className="flex flex-wrap justify-around items-center p-[2rem]">{movies?.map((movie) => (
                        <Link key={movie._id} to={`/admin/movies/updatemovie/${movie._id}`}
                            ...
                            <div className="flex">
                                <div key={movie._id}
                                    ...
                                    <div className="mt-[2rem] mb-[1rem]">
                                        <Link
                                            to={`/admin/movies/updatemovie/${movie._id}`}
